...
class BIP66Test(LyokocoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # lyokocoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and lyokocoind produces more specific reject
            # reasons.
