...
from test_framework.test_framework import LyokocoinTestFramework, SkipTest
...
class ZMQTest (LyokocoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that lyokocoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("lyokocoind has not been built with zmq enabled.")
