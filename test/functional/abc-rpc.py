...
# Exercise the Lyokocoin ABC RPC calls.
...
class ABC_RPC_Test (LyokocoinTestFramework):
    ...
    def test_excessiveblock(self):
        ...
        self.check_subversion("/Lyokocoin ABC:.*\(EB2\.0; .*\)/")
        ...
        # Check for EB correctness in the subver string
        self.check_subversion("/Lyokocoin ABC:.*\(EB13\.0; .*\)/")
        ...
        # check for EB correctness in the subver string
        self.check_subversion("/Lyokocoin ABC:.*\(EB13\.1; .*\)/")
