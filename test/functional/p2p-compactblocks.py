...
# TestNode: A peer we use to send messages to lyokocoind, and store responses.
...
class CompactBlocksTest(LyokocoinTestFramework):
    ...
    # This test actually causes lyokocoind to (reasonably!) disconnect us, so do
    # this last.
    ...
    # Test that lyokocoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for lyokocoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # lyokocoind will not send blocktxn responses for blocks whose height is
