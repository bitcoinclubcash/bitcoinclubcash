...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the LyokocoinTestFramework
    pass


class ExampleTest(LyokocoinTestFramework):
    # Each functional test is a subclass of the LyokocoinTestFramework class.
    ...
    def custom_method(self):
        ...
        LyokocoinTestFramework class so other tests can use it."""
