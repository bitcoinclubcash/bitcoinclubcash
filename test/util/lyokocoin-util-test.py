...
# Copyright 2016-2017 The Lyokocoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for lyokocoin utils.
...
def main():
    ...
    bctester(config["environment"]["SRCDIR"] + "/test/util/data",
             "lyokocoin-util-test.json", config["environment"])
...
def bctest(testDir, testObj, buildenv):
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, lyokocoin-tx
