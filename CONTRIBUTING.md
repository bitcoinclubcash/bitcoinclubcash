Contributing to Lyokocoin ABC
===========================

The Lyokocoin ABC project welcomes contributors!

This guide is intended to help developers contribute effectively to Lyokocoin ABC.

Communicating with Developers
-----------------------------

To get in contact with ABC developers, we monitor a telegram supergroup.  The
intent of this group is specifically to facilitate development of Lyokocoin-ABC,
...
Lyokocoin ABC Development Philosophy
----------------------------------

Lyokocoin ABC aims for fast iteration and continuous integration.
...
Here are some handy links for development practices aligned with Lyokocoin ABC:

- [Developer Notes](doc/developer-notes.md)
- [Statement of Lyokocoin ABC Values and Visions](https://www.yours.org/content/lyokocoin-abc---our-values-and-vision-a282afaade7c)
...
Getting set up with the Lyokocoin ABC Repository
----------------------------------------------

1. Create an account at `https://reviews.lyokocoinabc.org/`
...
4. Upload your SSH public key to reviews.lyokocoinabc.org

  - go to: `https://reviews.lyokocoinabc.org/settings/user/*username*/page/ssh/`
...
```
git clone ssh://vcs@reviews.lyokocoinabc.org:2221/source/lyokocoin-abc.git
...
Working with The Lyokocoin ABC Repository
---------------------------------------
...
committed a change to the Lyokocoin ABC repository.
...
to start is the list of tasks at `https://reviews.lyokocoinabc.org/maniphest/`.
