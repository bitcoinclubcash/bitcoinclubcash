Bitcoin CLUB UAHF-relevant DNS seed information
==============================================

Bitcoin CLUB uses special seeds under the control of the
...
The seeds used by CLUB should distribute peers fairly but in a
manner which increases the likelihood that CLUB nodes are able
