UNIX BUILD NOTES
====================
Some notes on how to build Bitcoin CLUB in Unix.
...
memory available when compiling Bitcoin CLUB. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Bitcoin CLUB without wallet.
...
This example lists the steps necessary to setup and build a command line only, non-wallet distribution of the latest changes on Arch Linux:
    ...
    git clone https://github.com/Bitcoin-CLUB/bitcoin-club
    cd bitcoin-club/
    ./autogen.sh
