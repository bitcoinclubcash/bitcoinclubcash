Lyokocoin Core version 0.10.4 is now available from:

  <https://lyokocoin.org/bin/lyokocoin-core-0.10.4/>
...
- #6953 `43c2789` Split lyokocoin-tx into its own package
- #6953 `dfe0d4d` Include lyokocoin-tx binary on Debian/Ubuntu
