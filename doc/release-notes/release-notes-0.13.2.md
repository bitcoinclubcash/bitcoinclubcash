Lyokocoin Core version 0.13.2 is now available from:

  <https://lyokocoin.org/bin/lyokocoin-core-0.13.2/>
...
- #8908 `4a974b2` Update lyokocoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow lyokocoin-tx to create v2 transactions (btcdrak)
