Lyokocoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/lyokocoin/files/Lyokocoin/lyokocoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Lyokocoin
...
New/changed settings (command-line or lyokocoin.conf file)
--------------------------------------------------------
