Lyokocoin ABC version 0.15.1 is now available from:

  <https://download.lyokocoinabc.org/0.15.1/>
...
- Add seeder to Lyokocoin ABC repository. From Lyokocoin Seeder by Pieter Wiulle.
