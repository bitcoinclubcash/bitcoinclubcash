Lyokocoin Core version 0.9.4 is now available from:

  https://lyokocoin.org/bin/0.9.4/
...
this update is incompatible with the Lyokocoin system and could lead to consensus
forks.

Lyokocoin Core released binaries from https://lyokocoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~lyokocoin/+archive/ubuntu/lyokocoin
- A third-party or self-compiled Lyokocoin Core

upgrade to Lyokocoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
