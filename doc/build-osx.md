...
1. Clone the Bitcoin CLUB source code and cd into `bitcoin-club`

        git clone github.com/Bitcoin-CLUB/bitcoin-club
        cd bitcoin-club

2.  Build bitcoin-club:
...
Bitcoin CLUB is now available at `./src/bitcoind`
