...
This document provides guidelines for internationalization of the Lyokocoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lyokocoin_en.ts` remains unchanged.
