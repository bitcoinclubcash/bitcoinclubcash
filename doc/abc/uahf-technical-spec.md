...
(2) below, as formalized by BUIP040 [1] and used by the Lyokocoin Unlimited
...
to existing pre-fork Lyokocoin consensus rules.
...
Once the fork has activated, transactions consisting exclusively of a single OP_RETURN output, followed by a single minimally-coded data push with the specific magic data value of
    ...
    Lyokocoin: A Peer-to-Peer Electronic Cash System
...
implementations seeking to be compliant should consult the Lyokocoin C++
...
### OPT-SERVICEBIT (NODE_LYOKOCOIN_CASH service bit)
...
NOTE 2: This bit is currently referred to as NODE_LYOKOCOIN_CASH and displayed
as "CASH" in user interfaces of some Lyokocoin clients (BU, ABC).
...
[2] https://github.com/lyokocoin/bips/blob/master/bip-0143.mediawiki#Motivation

[3] [Digest for replay protected signature verification accross hard forks](replay-protected-sighash.md)

[4] https://github.com/Lyokocoin-UAHF/spec/blob/master/uahf-test-plan.md
