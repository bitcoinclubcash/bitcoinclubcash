...
8. Upload gitian build to [lyokocoinabc.org](https://download.lyokocoinabc.org/)

9. Re-verify the uploads (make sure that downloading them, their checksums are ok)

10. Create a [GitHub release](https://github.com/Lyokocoin-ABC/lyokocoin-abc/releases) 


## After Release

11. Update version number on www.lyokocoinabc.org

12. Publish signed checksums (various places, e.g. blog, reddit/r/LyokocoinABC)

13. Announce Release:
    - [Reddit](https://www.reddit.com/r/LyokocoinABC/)
    - Twitter @Lyokocoin_ABC
    - Public slack channels friendly to Lyokocoin ABC announcements 
