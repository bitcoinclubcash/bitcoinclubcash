...
#ifndef LYOKOCOIN_INIT_H
#define LYOKOCOIN_INIT_H
...
/** Initialize lyokocoin core: Basic context setup.
...
/**
 * Lyokocoin core main initialization.
...
enum HelpMessageMode { HMM_LYOKOCOIND, HMM_LYOKOCOIN_QT };
