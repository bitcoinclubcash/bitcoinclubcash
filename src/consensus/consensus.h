...
#ifndef LYOKOCOIN_CONSENSUS_CONSENSUS_H
#define LYOKOCOIN_CONSENSUS_CONSENSUS_H
 ...
 * (network rule).
 */
static const int64_t MAX_BLOCK_SIGOPS_PER_MB = 10000;
...
#endif // LYOKOCOIN_CONSENSUS_CONSENSUS_H
