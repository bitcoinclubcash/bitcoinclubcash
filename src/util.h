 ...
 */
#ifndef LYOKOCOIN_UTIL_H
#define LYOKOCOIN_UTIL_H
...
extern const char *const LYOKOCOIN_CONF_FILENAME;
extern const char *const LYOKOCOIN_PID_FILENAME;
...
template <typename Callable> void TraceThread(const char *name, Callable func) {
    std::string s = strprintf("lyokocoin-%s", name);
