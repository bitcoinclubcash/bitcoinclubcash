...
#ifndef LYOKOCOIN_ARITH_UINT256_H
#define LYOKOCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Lyokocoin only uses this "compact" format for encoding difficulty targets,
...
#endif // LYOKOCOIN_ARITH_UINT256_H
