...
#ifndef LYOKOCOIN_WALLET_WALLET_H
#define LYOKOCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this lyokocoin node, and set to 0 for transactions that were created
...
#endif // LYOKOCOIN_WALLET_WALLET_H
