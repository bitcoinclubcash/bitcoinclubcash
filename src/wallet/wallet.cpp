...
void CWallet::AvailableCoins(std::vector<COutput> &vCoins, bool fOnlySafe,
    ...
    for (std::map<uint256, CWalletTx>::const_iterator it = mapWallet.begin();
        ...
        // Lyokocoin-ABC: Removed check that prevents consideration of coins from
        ...
        // Lyokocoin-ABC: retained this check as 'replaced_by_txid' is still set
        // in the wallet code.
...

    {
        ...
        while (true) {
            ...
            if (nChange > Amount(0)) {
                ...
                // transaction isn't always pay-to-lyokocoin-address.
 ...
 * https://lyokocointalk.org/?topic=54527, or
 * https://github.com/lyokocoin/lyokocoin/pull/1393.
 */
