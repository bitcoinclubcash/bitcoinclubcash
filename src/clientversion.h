...
#ifndef LYOKOCOIN_CLIENTVERSION_H
#define LYOKOCOIN_CLIENTVERSION_H
...
//! These need to be macros, as clientversion.cpp's and lyokocoin*-res.rc's voodoo
//! requires it
...
/**
 * lyokocoind-res.rc includes this file, but it cannot cope with real c++ code.
...
#endif // LYOKOCOIN_CLIENTVERSION_H
