...
#ifndef LYOKOCOIN_RPCPROTOCOL_H
#define LYOKOCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode {
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in lyokocoind
