...
// NOTE: Unlike wallet RPC (which use LOC values), mining RPCs follow GBT (BIP
...
static UniValue getblocktemplate(const Config &config,
    ...
    if (request.fHelp || request.params.size() > 1) {
        throw std::runtime_error(
            ...
            "    "
            "https://github.com/lyokocoin/bips/blob/master/bip-0022.mediawiki\n"
            "    "
            "https://github.com/lyokocoin/bips/blob/master/bip-0023.mediawiki\n"
            "    "
            "https://github.com/lyokocoin/bips/blob/master/"
            "bip-0009.mediawiki#getblocktemplate_changes\n"
            "    "
            "https://github.com/lyokocoin/bips/blob/master/bip-0145.mediawiki\n"
    ...
    if (g_connman->GetNodeCount(CConnman::CONNECTIONS_ALL) == 0) {
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED,
                           "Lyokocoin is not connected!");
    }

    if (IsInitialBlockDownload()) {
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD,
                           "Lyokocoin is downloading blocks...");
    }
...
static UniValue submitblock(const Config &config,
    ...
    if (request.fHelp || request.params.size() < 1 ||
        ...
        throw std::runtime_error(
            ...
            "See https://en.lyokocoin.it/wiki/BIP_0022 for full specification.\n"
