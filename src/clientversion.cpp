 ...
 * for both lyokocoind and lyokocoin-abc, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("Lyokocoin ABC");
...
#ifdef GIT_ARCHIVE
#define GIT_COMMIT_ID "f5f1555c1"
#define GIT_COMMIT_DATE "Wed, 30 May 2018 18:29:17 -0700"
#endif
 ...
 * (https://github.com/lyokocoin/bips/blob/master/bip-0014.mediawiki)
 */
