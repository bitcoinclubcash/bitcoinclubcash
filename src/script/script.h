...
#ifndef LYOKOCOIN_SCRIPT_SCRIPT_H
#define LYOKOCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Lyokocoin always counted CHECKMULTISIGs as 20 sigops. With
...
#endif // LYOKOCOIN_SCRIPT_SCRIPT_H
