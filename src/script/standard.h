...
#ifndef LYOKOCOIN_SCRIPT_STANDARD_H
#define LYOKOCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a lyokocoin address
 */
...
#endif // LYOKOCOIN_SCRIPT_STANDARD_H
