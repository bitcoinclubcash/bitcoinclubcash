...
#ifndef LYOKOCOIN_TEST_SCRIPTNUM10_H
#define LYOKOCOIN_TEST_SCRIPTNUM10_H
...
class CScriptNum10 {
    /**
     * The ScriptNum implementation from Lyokocoin Core 0.10.0, for
     * cross-comparison.
     */
public:
