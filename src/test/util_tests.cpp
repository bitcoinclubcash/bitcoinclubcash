...
BOOST_AUTO_TEST_CASE(util_TimingResistantEqual) {
    ...
    BOOST_CHECK(!TimingResistantEqual(std::string("club"), std::string("")));
    BOOST_CHECK(!TimingResistantEqual(std::string(""), std::string("club")));
    BOOST_CHECK(!TimingResistantEqual(std::string("a"), std::string("aa")));
    BOOST_CHECK(!TimingResistantEqual(std::string("aa"), std::string("a")));
    BOOST_CHECK(TimingResistantEqual(std::string("club"), std::string("club")));
    BOOST_CHECK(!TimingResistantEqual(std::string("club"), std::string("aba")));
}
