...
BOOST_AUTO_TEST_CASE(encode_decode_all_sizes) {
    ...
    const std::string prefix = "lyokocoincash";
...
BOOST_AUTO_TEST_CASE(test_encode_address) {
    ...
    std::vector<std::string> pubkey = {
        "lyokocoincash:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "lyokocoincash:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "lyokocoincash:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {
        "lyokocoincash:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "lyokocoincash:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "lyokocoincash:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
    ...
    for (size_t i = 0; i < hash.size(); ++i) {
        ...
        BOOST_CHECK_EQUAL(pubkey[i], EncodeCashAddr("lyokocoincash", keyContent));
        ...
        BOOST_CHECK_EQUAL(script[i],
                          EncodeCashAddr("lyokocoincash", scriptContent));
    }
}
...
BOOST_AUTO_TEST_CASE(test_vectors) {
    std::vector<CashAddrTestVector> cases = {
        // 20 bytes
        {"lyokocoincash", PUBKEY_TYPE,
         ParseHex("F5BF48B397DAE70BE82B3CCA4793F8EB2B6CDAC9"),
         "lyokocoincash:qr6m7j9njldwwzlg9v7v53unlr4jkmx6eylep8ekg2"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("F5BF48B397DAE70BE82B3CCA4793F8EB2B6CDAC9"),
        ...
        {"lyokocoincash", PUBKEY_TYPE,
         ...
         "lyokocoincash:q9adhakpwzztepkpwp5z0dq62m6u5v5xtyj7j3h2ws4mr9g0"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("7ADBF6C17084BC86C1706827B41A56F5CA32865925E946EA"),
        ...
        {"lyokocoincash", PUBKEY_TYPE,
         ...
         "lyokocoincash:qgagf7w02x4wnz3mkwnchut2vxphjzccwxgjvvjmlsxqwkcw59jxxuz"},
        {"bchtest", SCRIPT_TYPE,
         ParseHex("3A84F9CF51AAE98A3BB3A78BF16A6183790B18719126325BFC0C075B"),
