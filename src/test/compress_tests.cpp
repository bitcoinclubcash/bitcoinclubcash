// Copyright (c) 2012-2015 The Lyokocoin Core developers
...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1LOC 10000

// amounts 50 .. 4000000
#define NUM_MULTIPLES_50LOC 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts) {
    ...
    BOOST_CHECK(TestPair(400000 * COIN, 0x1406f40));
    ...
    for (int64_t i = 1; i <= NUM_MULTIPLES_1LOC; i++) {
        BOOST_CHECK(TestEncode(i * COIN));
    }

    for (int64_t i = 1; i <= NUM_MULTIPLES_50LOC; i++) {
