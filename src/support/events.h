...
#ifndef LYOKOCOIN_SUPPORT_EVENTS_H
#define LYOKOCOIN_SUPPORT_EVENTS_H
...
raii_event obtain_event(struct event_base *base, evutil_socket_t s,
...
#endif // LYOKOCOIN_SUPPORT_EVENTS_H
