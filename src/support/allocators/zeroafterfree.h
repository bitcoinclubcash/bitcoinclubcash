...
#ifndef LYOKOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define LYOKOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // LYOKOCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
