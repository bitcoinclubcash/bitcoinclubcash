...
enum ServiceFlags : uint64_t {
    ...
    // It is currently set by all Bitcoin CLUB nodes, and is unset by SPV clients
    ...
    // protocol request. Bitcoin CLUB does not support this but a patch set
    ...
    // connections. Bitcoin CLUB nodes used to support this by default, without
