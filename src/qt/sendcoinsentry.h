...
#ifndef LYOKOCOIN_QT_SENDCOINSENTRY_H
#define LYOKOCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending lyokocoins.
...
#endif // LYOKOCOIN_QT_SENDCOINSENTRY_H
