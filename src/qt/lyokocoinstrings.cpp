...
#define UNUSED
#endif
static const char UNUSED *lyokocoin_strings[] = {
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Lyokocoin ABC"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "The %s developers"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      ""
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "%s corrupt, salvage failed"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "%s is set very high!"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "(default: %s)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "(default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "-maxmempool must be at least %d MB"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "<category> can be:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Append comment to the user agent string"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Attempt to recover private keys from a corrupt wallet on startup"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Automatically create Tor hidden service (default: %d)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Block creation options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Cannot downgrade wallet"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Cannot resolve -%s address: '%s'"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Cannot write default address"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Chain selection options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Change index out of range"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Connect through SOCKS5 proxy"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Connect to a node to retrieve peer addresses, and disconnect"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Connection options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Copyright (C) %i-%i"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Corrupted block database detected"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Debugging/Testing options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Do not load the wallet and disable wallet RPC calls"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Do you want to rebuild the block database now?"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Done loading"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Enable publish hash block in <address>"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Enable publish hash transaction in <address>"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Enable publish raw block in <address>"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Enable publish raw transaction in <address>"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Enable transaction replacement in the memory pool (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error initializing block database"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Error initializing wallet database environment %s!"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error loading %s"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error loading %s: Wallet corrupted"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Error loading %s: Wallet requires newer version of %s"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error loading %s: You can't disable HD "
                                     "on a already existing HD wallet"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error loading block database"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error opening block database"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Error reading from database, shutting down."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Error: A fatal internal error occurred, see debug.log for details"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Error: Disk space is low!"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Importing..."),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Information"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Initialization sanity check failed. %s is shutting down."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Insufficient funds"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Invalid -onion address: '%s'"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Invalid -proxy address: '%s'"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Invalid amount for -%s=<amount>: '%s'"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Listen for JSON-RPC connections on "
                                     "<port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Listen for connections on <port> (default: %u or testnet: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Loading addresses..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Loading banlist..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Loading block index..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Loading wallet..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Location of the auth cookie (default: data dir)"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Maintain at most <n> connections to peers (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Make the wallet broadcast transactions"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Node relay options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Not enough file descriptors available."),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Only connect to nodes in network <net> (ipv4, ipv6 or onion)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Password for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Prepend debug output with timestamp (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Print this help message and exit"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Print version and exit"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Prune cannot be configured with a negative value."),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Prune mode is incompatible with -txindex."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Pruning blockstore..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "RPC server options:"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Rebuild chain state and block index from the blk*.dat files on disk"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Rebuild chain state from the currently indexed blocks"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Reducing -maxconnections from %d to %d, "
                                     "because of system limitations."),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Relay and mine data carrier transactions (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Relay non-P2SH multisig (default: %u)"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Rescan the block chain for missing wallet transactions on startup"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Rescanning..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Rewinding blocks..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Set key pool size to <n> (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Signing transaction failed"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Specify configuration file (default: %s)"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Specify data directory"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Specify pid file (default: %s)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Specify wallet file (within data directory)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Specify your own public address"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Spend unconfirmed change when sending transactions (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Starting network threads..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "The source code is available from %s."),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "The transaction amount is too small to pay the fee"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "The wallet will avoid paying less than the minimum relay fee."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "This is experimental software."),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Transaction amount too small"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Transaction too large for fee policy"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Transaction too large"),
    QT_TRANSLATE_NOOP(
        "lyokocoin-abc",
        "Unable to bind to %s on this computer (bind returned error %s)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Unable to bind to %s on this computer. "
    ...
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Use the test chain"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "User Agent comment (%s) contains unsafe characters."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Username for JSON-RPC connections"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Verifying blocks..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Verifying wallet..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Wallet %s resides outside data directory %s"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Wallet debugging/testing options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Wallet needed to be rewritten: restart %s to complete"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Wallet options:"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Warning"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Warning: unknown new rules activated (versionbit %i)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc",
                      "Whether to operate in a blocks only mode (default: %u)"),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "Zapping all transactions from wallet..."),
    QT_TRANSLATE_NOOP("lyokocoin-abc", "ZeroMQ notification options:"),
};
