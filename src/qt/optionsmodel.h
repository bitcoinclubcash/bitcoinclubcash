...
#ifndef LYOKOCOIN_QT_OPTIONSMODEL_H
#define LYOKOCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Lyokocoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,          // QString
        ProxyPortTor,        // int
        DisplayUnit,         // LyokocoinUnits::Unit
...
#endif // LYOKOCOIN_QT_OPTIONSMODEL_H
