...
OpenURIDialog::OpenURIDialog(const Config *cfg, QWidget *parent)
    ...
    ui->uriEdit->setPlaceholderText(GUIUtil::lyokocoinURIScheme(*cfg) + ":");
#endif
}
...
void OpenURIDialog::accept() {
    ...
    QString uriScheme = GUIUtil::lyokocoinURIScheme(*cfg);
    if (GUIUtil::parseLyokocoinURI(uriScheme, getURI(), &rcp)) {
...
void OpenURIDialog::on_selectFileButton_clicked() {
    ...
    ui->uriEdit->setText(GUIUtil::lyokocoinURIScheme(*cfg) +
