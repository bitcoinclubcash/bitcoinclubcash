...
/* Window elements init */
    ...
    ui->lyokocoinAtStartup->setToolTip(
        ui->lyokocoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->lyokocoinAtStartup->setText(
        ui->lyokocoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LyokocoinUnits(this));
...
void OptionsDialog::setMapper() {
    /* Main */
    mapper->addMapping(ui->lyokocoinAtStartup, OptionsModel::StartAtStartup);
