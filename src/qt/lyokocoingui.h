...
#ifndef LYOKOCOIN_QT_LYOKOCOINGUI_H
#define LYOKOCOIN_QT_LYOKOCOINGUI_H
...
public:
    ...
    explicit LyokocoinGUI(const Config *, const PlatformStyle *platformStyle,
     ...
     * The wallet model represents a lyokocoin wallet, and offers access to the
...
#endif // LYOKOCOIN_QT_LYOKOCOINGUI_H
