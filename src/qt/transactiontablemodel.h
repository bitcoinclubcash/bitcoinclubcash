...
#ifndef LYOKOCOIN_QT_TRANSACTIONTABLEMODEL_H
#define LYOKOCOIN_QT_TRANSACTIONTABLEMODEL_H
...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx,
                           ...
                           LyokocoinUnits::SeparatorStyle separators =
                               LyokocoinUnits::separatorStandard) const;
...
#endif // LYOKOCOIN_QT_TRANSACTIONTABLEMODEL_H
