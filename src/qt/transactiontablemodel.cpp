...
TransactionTableModel::TransactionTableModel(
    ...
    columns << QString() << QString() << tr("Date") << tr("Type") << tr("Label")
            << LyokocoinUnits::getAmountColumnTitle(
...
void TransactionTableModel::updateAmountColumnTitle() {
    columns[Amount] = LyokocoinUnits::getAmountColumnTitle(
        walletModel->getOptionsModel()->getDisplayUnit());
...
QString TransactionTableModel::formatTxAmount(
    ...
    LyokocoinUnits::SeparatorStyle separators) const {
    QString str =
        LyokocoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(),
...
QVariant TransactionTableModel::data(const QModelIndex &index, int role) const {
    ...
    switch (role) {
        ...
        case TxPlainTextRole: {
            ...
            details.append(
                formatTxAmount(rec, false, LyokocoinUnits::separatorNever));
            return details;
        }
        case ConfirmedRole:
        ...
        case FormattedAmountRole:
            ...
            return formatTxAmount(rec, false, LyokocoinUnits::separatorNever);
        case StatusRole:
