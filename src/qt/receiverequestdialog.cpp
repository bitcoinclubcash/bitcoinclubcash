...
#include "config/lyokocoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update() {
    ...
    QString uri = GUIUtil::formatLyokocoinURI(*config, info);
...
void ReceiveRequestDialog::on_btnCopyURI_clicked() {
    GUIUtil::setClipboard(GUIUtil::formatLyokocoinURI(*config, info));
}
