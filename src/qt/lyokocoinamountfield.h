...
#ifndef LYOKOCOIN_QT_LYOKOCOINAMOUNTFIELD_H
#define LYOKOCOIN_QT_LYOKOCOINAMOUNTFIELD_H
...
/** Widget for entering lyokocoin amounts.
 */
class LyokocoinAmountField : public QWidget {
    Q_OBJECT
...
public:
    explicit LyokocoinAmountField(QWidget *parent = 0);
...
#endif // LYOKOCOIN_QT_LYOKOCOINAMOUNTFIELD_H
