...
#ifndef LYOKOCOIN_QT_SPLASHSCREEN_H
#define LYOKOCOIN_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. Lyokocoin Core initialization
...
#endif // LYOKOCOIN_QT_SPLASHSCREEN_H
