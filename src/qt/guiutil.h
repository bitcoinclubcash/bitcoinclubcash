...
#ifndef LYOKOCOIN_QT_GUIUTIL_H
#define LYOKOCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Lyokocoin Qt UI.
 */
namespace GUIUtil {
...
QString lyokocoinURIScheme(const CChainParams &, bool useCashAddr);
QString lyokocoinURIScheme(const Config &);
// Parse "lyokocoincash:" URI into recipient object, return true on successful
// parsing
