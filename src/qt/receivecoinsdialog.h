...
#ifndef LYOKOCOIN_QT_RECEIVECOINSDIALOG_H
#define LYOKOCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of lyokocoins */
...
#endif // LYOKOCOIN_QT_RECEIVECOINSDIALOG_H
