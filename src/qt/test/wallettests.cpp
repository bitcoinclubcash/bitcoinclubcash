...
#include "dstencode.h"
#include "qt/lyokocoinamountfield.h"
...
uint256 SendCoins(CWallet &wallet, SendCoinsDialog &sendCoinsDialog,
    ...
    entry->findChild<LyokocoinAmountField *>("payAmount")->setValue(amount);
    uint256 txid;
...
//
//     src/qt/test/test_lyokocoin-qt -platform xcb      # Linux
//     src/qt/test/test_lyokocoin-qt -platform windows  # Windows
//     src/qt/test/test_lyokocoin-qt -platform cocoa    # macOS
