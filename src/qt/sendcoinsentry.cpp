...
SendCoinsEntry::SendCoinsEntry(const PlatformStyle *_platformStyle,
    ...
    ui->messageTextLabel->setToolTip(
        tr("A message that was attached to the %1 URI which will be"
           ...
           "This message will not be sent over the Lyokocoin network.")
            .arg(GUIUtil::lyokocoinURIScheme(GetConfig())));
    ...
    // normal lyokocoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying lyokocoin address(es)
