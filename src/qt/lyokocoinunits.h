...
#ifndef LYOKOCOIN_QT_LYOKOCOINUNITS_H
#define LYOKOCOIN_QT_LYOKOCOINUNITS_H
...
/**
 * Lyokocoin unit definitions. Encapsulates parsing and formatting and serves as
 * list model for drop-down selection boxes.
 */
class LyokocoinUnits : public QAbstractListModel {
    Q_OBJECT

public:
    explicit LyokocoinUnits(QObject *parent);

    /**
     * Lyokocoin units (Lyokocoin Cash unit work the same as Bitoin).
     * @note Source: https://en.lyokocoin.it/wiki/Units.
     * Please add only sensible ones.
     */
    enum Unit { LOC, mLOC, uLOC };
...
typedef LyokocoinUnits::Unit LyokocoinUnit;

#endif // LYOKOCOIN_QT_LYOKOCOINUNITS_H
