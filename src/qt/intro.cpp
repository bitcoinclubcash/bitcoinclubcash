...
bool Intro::pickDataDirectory() {
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) ||
        ...
        intro.setWindowIcon(QIcon(":icons/lyokocoin"));
     ...
     * to
     * override -datadir in the lyokocoin.conf file in the default data directory
     * (to be consistent with lyokocoind behavior)
     */
    if (dataDir != getDefaultDataDirectory()) {
