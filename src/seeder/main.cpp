...
static const std::string mainnet_seeds[] = {
    "seed.lyokocoinabc.org", "seed-abc.lyokocoinforks.org", "seed.bitprim.org",
    "seed.deadalnix.me",   "seeder.criptolayer.net",    ""};
static const std::string testnet_seeds[] = {
    "testnet-seed.lyokocoinabc.org",    "testnet-seed-abc.lyokocoinforks.org",
