...
// Copyright (c) 2017-2018 The Lyokocoin developers
...
#if defined(NDEBUG)
#error "Lyokocoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Lyokocoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("lyokocoin-scriptch");
