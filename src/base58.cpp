...
void CLyokocoinSecret::SetKey(const CKey &vchSecret) {
...
bool CLyokocoinSecret::IsValid() const {
...
bool CLyokocoinSecret::SetString(const char *pszSecret) {
    return CBase58Data::SetString(pszSecret) && IsValid();
}

bool CLyokocoinSecret::SetString(const std::string &strSecret) {
