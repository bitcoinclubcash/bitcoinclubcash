...
echo "export URL=https://github.com/Lyokocoin-ABC/lyokocoin-abc.git"
echo "cd gitian-builder"
echo './bin/make-base-vm --lxc --suite xenial --arch amd64'
echo './bin/gbuild --commit lyokocoin=${COMMIT} --url lyokocoin=${URL} /vagrant/contrib/gitian-descriptors/gitian-linux.yml'